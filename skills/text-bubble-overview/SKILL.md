...
description: 画像に縦書き吹き出しを合成し、assign / reflow / scene / render / run / full の各段階で text-bubble CLI を使いたいときに使う。llama-server、mask、renderer、workspace の入口もこの skill から辿れる。
---
...
- workspace、mask、renderer、llama-server の前提を素早く見たい
...
- 入力: 元画像、dialogue、mask、llama-server
